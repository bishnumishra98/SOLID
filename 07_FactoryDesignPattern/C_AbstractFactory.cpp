// ● C++ Code Example of Abstract Factory Design Pattern
//   In the below example, we have two product families: Burgers and Garlic Breads.
//   Each product family has multiple concrete implementations.
//   The MealFactory is an abstract factory that declares methods for creating each type of product.
//   We have two concrete factories, SinghBurger and KingBurger, that implement the creation methods
//   to produce different variants of burgers and garlic breads.
//   The main function demonstrates how to use these factories to create and prepare a meal consisting of
//   a burger and garlic bread.
...
int main() {
    ...
    burger->prepare();   // o/p: Preparing Basic Wheat Burger with bun, patty, and ketchup!
    garlicBread->prepare();   // o/p: Preparing Cheese Wheat Garlic Bread with extra cheese and butter!
